...
Firstly, we need to load some libraries (`sf` and `tmap`) and a new one - `dplyr`. Remember to install it if you need to. Then we need to read in and join the LSOA data. 
