...
The latest version of the PDF is available from https://github.com/nickbearman/advanced-r-gis. This is v7.1 and this was created on `r format(Sys.time(), '%d %B %Y')`.
